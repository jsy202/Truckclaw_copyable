...
Inbound gate: 현재 Discord 메시지가 `<@1479297098938585170>` 또는 `@TRUCKCLAW3`을
...
```
<@1479297673432399923> 확인했어, 나는 [destination_id]로 가야 해.
...
- `<@1479297098938585170>` 멘션이 없는 메시지에는 응답하지 않는다.
