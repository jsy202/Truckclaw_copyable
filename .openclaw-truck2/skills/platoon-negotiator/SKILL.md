...
```
<@1479297098938585170> 안녕, TRUCKCLAW3.
...
```
<@1479297098938585170> CARLA 분기 완료 확인.
...
- 이 스킬은 `<@1479297673432399923>` 또는 `@TRUCKCLAW2` 멘션이 있을 때만 실행.
...
- TRUCKCLAW3에게 보내는 모든 메시지는 `<@1479297098938585170>`로 시작한다.
